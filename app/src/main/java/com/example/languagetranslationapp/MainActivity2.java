...
public class MainActivity2 extends AppCompatActivity {
        ...
        translateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sourceEdt.getText().toString().isEmpty()) {
                    Toast.makeText(MainActivity2.this, "Please enter your text to translate", Toast.LENGTH_SHORT).show();
                } else if (fromLanguageCode == 0) {
                    Toast.makeText(MainActivity2.this, "Please select source language", Toast.LENGTH_SHORT).show();
                } else if (toLanguageCode == 0) {
                    Toast.makeText(MainActivity2.this, "Please select the language to make tanslation", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void translateText(int fromLanguageCode, int toLanguageCode, String source) {
        ...
        translator.downloadModelIfNeeded(conditions).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                ...
                translator.translate(source).addOnSuccessListener(new OnSuccessListener<String>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MainActivity2.this, "Fail to translate : " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(MainActivity2.this, "Fail to download language Model " + e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
